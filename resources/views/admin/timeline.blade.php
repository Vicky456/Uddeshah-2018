...
@section('content')
    <div class="padding">
        <ul class="timeline timeline-center" ui-class="timeline-center">
            <li class="tl-header">
                <div class="btn white active" ui-toggle-class="timeline-center" ui-target=".timeline">Center me</div>
            </li>
            <li class="tl-item">
                <div class="tl-wrap b-info">
                    <span class="tl-date text-muted">1h ago</span>
            ...
            <li class="tl-item">
                <div class="tl-wrap b-success">
                    ...
                    <div class="tl-content box-color text-color  p-a-sm">
                        ...
                        <div>Content in a box with arrow</div>
                    </div>
                </div>
            </li>
